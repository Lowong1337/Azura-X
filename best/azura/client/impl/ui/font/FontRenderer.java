...
public class FontRenderer extends net.minecraft.client.gui.FontRenderer {
    ...
    public FontRenderer(Font font) {
        super(Minecraft.getMinecraft().gameSettings, new ResourceLocation("textures/font/ascii.png"), Minecraft.getMinecraft().getTextureManager(), Minecraft.getMinecraft().getLanguageManager().isCurrentLocaleUnicode());
